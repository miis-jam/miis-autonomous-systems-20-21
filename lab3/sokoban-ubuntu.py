...
def main(argv):
    ...
    #os.system("./downward/fast-downward.py --alias seq-sat-lama-2011 domain.pddl problem-out.pddl --plan-file sas_plan")
    #os.system("./downward/fast-downward.py domain.pddl problem-out.pddl --search 'lazy_greedy([ff()], preferred=[ff()])'")
    #./fast-downward.py --alias seq-sat-lama-2011 domain.pddl task.pddl
    os.system("./downward/fast-downward.py --plan-file sas_plan --alias seq-sat-lama-2011 domain.pddl problem-out.pddl")
